...
bool authenticate_user(const char *username, const char *pswd){
    ...
    const char *conn_string = "host=localhost port=5434 dbname=multichat user=Giorgio password=";
                                              // DA MODIFICARE CON 5432  // DA MODIFICARE con postgres e password "password"
